  ...
  (lambda (lang id)
    (let ([lang-name (language-name lang)]
      ...
      (let ([nt-counter (annotate-ntspec*! ntspec*)])
        (let ([bits (integer-length nt-counter)])
